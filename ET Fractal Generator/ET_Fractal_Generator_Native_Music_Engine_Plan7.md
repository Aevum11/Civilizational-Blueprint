...
- **Temporal:** Resolution varies across video frames. Starts at N_min, climbs the LCM tower to N_max. The fractal reveals its structure progressively — shadow families fade in as they become native.
...
```
  ...
  │     T  Temporal (video: coarse→fine over time)               │
