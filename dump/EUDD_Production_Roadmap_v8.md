...
- **E_hierarchy computation:** **RESOLVED.** Crystalline formula derived and specified in EUDD v18 §4.5: E_hierarchy = geomean(E_i) × R_cluster, where R_cluster = 100/(100 + σ_ε). Geometric mean for individual quality, resonance factor for mutual coherence.
