...
Example at N=12: k₁=4 (d=3) × k₂=8 (d=3) → k=12 (d=1). 
  lcm(3,3)=3 but d_product=1. Two d=3 sublattice configurations
  combined to produce a d=1 sublattice configuration.
  (At the harmonic family layer, d=3 carries the strong-force
  identification and d=1 carries gravity — but those are harmonic
  family attributions via the Sublattice Visitation Theorem, NOT
  properties of the sublattice family arithmetic itself.)
""")
