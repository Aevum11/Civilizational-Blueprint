    ...
    <div style={{
      ...
      <svg viewBox={`0 0 ${W} ${H}`} style={{ width: "100%", maxWidth: W, margin: "0 auto", display: "block" }}>
        ...
        {fullTable.map((f, i) => {
          ...
          const bx = 40 + (i % 6) * 100, by = 1116 + Math.floor(i / 6) * 10;
          return (
            <text key={`ft${f.m}`} x={bx} y={by} fill={col} fontSize="5.5">
        ...
        <text x={303} y={1187} fill={t.legend} fontSize="6">κ=0 (D-arith, E{">"}1)</text>
        <line x1={400} y1={1184} x2={412} y2={1184} stroke={t.red} strokeWidth="1" />
        <text x={418} y={1187} fill={t.legend} fontSize="6">κ≠0 (T-act, E{"<"}1)</text>
