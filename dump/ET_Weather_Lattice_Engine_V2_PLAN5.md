...
**If the d-family structure is predictable while ε is chaotic, then "deterministic chaos" is actually structural determinism with fine-grained sensitivity.** The chaos is real — but it lives in the residual, not in the structure. The lattice sees through it.
