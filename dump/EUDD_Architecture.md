...
*§7.16 The Named Pipe API — 79 operations across 15 domains + 2 cross-domain, complete JSON schemas, wire format, metabolism registration, error taxonomy → See `EUDD_API_Reference.md`*
