...
# Version: 1.6.3 (Added Name to FractalReality + Enhanced Error Logging)
...
# Fix: Sky color changed from light_blue (non-existent) to azure (Ursina standard light blue)
# Fix: Handle __file__ not defined (e.g., in interactive shells) using sys.argv[0] fallback
# Fix: Added required 'name' argument to FractalReality init (per library signature)
...
# ============================================================================
# Handle __file__ not defined (interactive mode)
...
fallback_logger.info("PHASE 0: ET-Minecraft v1.6.3 Startup - Logging Initialized")
...
class ETWorld(Entity):
    def __init__(self):
        ...
        self.fractal = FractalReality("ETWorldFractal", seed=42)  # Fixed: Added required 'name' argument
        self.chunks = {}
        self.block_map = {}
        self.generate_world()
...
if __name__ == "__main__":
    ...
    try:
        ...
        Sky(color=color.azure)  # Fixed: Changed to azure (Ursina's light blue equivalent)
