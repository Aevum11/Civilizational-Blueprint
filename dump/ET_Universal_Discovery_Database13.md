...
...continue until home found or 120-dps precision limit reached
```
...
Home found → record as true_home / persistent_home / deep_home
  OR 120-dps precision limit reached → record as asymptotic approach
    ↓
...
3. Runs the full §7.11 escalation: 12ET → 60ET → 420ET → ... → home or precision limit
