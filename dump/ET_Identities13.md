...
$$k_u = A_0^{\text{magic}}(d_W) = (d_W\!-\!1)^2+S^2 = 25$$

$$\Delta k_{u \to d} = N\!+\!1 = 13, \quad \Delta k_{d \to s} = S(N\!+\!1) = 52, \quad \Delta k_{s \to c} = |\Pi|(N\!+\!|\Pi|) = 45$$

$$\Delta k_{c \to b} = |\Pi|(D_{\text{str}}\!-\!|\Pi|) = 21, \quad \Delta k_{b \to t} = K_{EM}^2 = 64, \quad \Sigma = (N\!+\!|\Pi|)(N\!+\!1) = 195$$

All six $k$-values match measured lattice positions exactly (PDG 2024 via Sempaevum Particle Viewer). Six quarks exhaust six families one-to-one: u↔d=12(EM), d↔d=6(Hex), s↔d=2(Tri), c↔d=4(Weak), b↔d=1(Grav), t↔d=3(Strong).
